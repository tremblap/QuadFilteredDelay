...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=QuadFilteredDelay Demo Installer\n"
      else:
        line="OutputBaseFilename=QuadFilteredDelay Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the QuadFilteredDelay Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the QuadFilteredDelay installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=QuadFilteredDelay Demo installer\n"
     else:
       line="SetupWindowTitle=QuadFilteredDelay installer\n"
