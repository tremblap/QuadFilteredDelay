...
def main():
  ...
  plistpath = scriptpath + "/resources/QuadFilteredDelay-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/QuadFilteredDelay-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/QuadFilteredDelay-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/QuadFilteredDelay-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/QuadFilteredDelay-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/QuadFilteredDelay.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/QuadFilteredDelay.iss",inplace=1):
